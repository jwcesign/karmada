...
// NewNewUpgradeDialerWithConfig creates a new UpgradeRoundTripper with the specified
// configuration.
func NewNewUpgradeDialerWithConfig(cfg UpgradeDialerWithConfig) *UpgradeDialer {
	if cfg.Proxier == nil {
...
func (s *UpgradeDialer) TLSClientConfig() *tls.Config {
	return s.tlsConfig
}
