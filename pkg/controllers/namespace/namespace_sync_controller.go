...
func (c *Controller) buildWorks(namespace *corev1.Namespace, clusters []clusterv1alpha1.Cluster) error {
	...
	for i := range clusters {
		go func(cluster *clusterv1alpha1.Cluster, ch chan<- error) {
			...
			util.MergeAnnotation(clonedNamespaced, workv1alpha2.WorkNamespaceAnnotationKey, workNamespace)
			util.MergeAnnotation(clonedNamespaced, workv1alpha2.WorkNameAnnotationKey, workName)
