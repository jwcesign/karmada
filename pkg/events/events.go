...
const (
	// EventReasonSyncServiceFailed is indicates that sync service work failed.
	EventReasonSyncServiceFailed string = "SyncServiceWorkFailed"
	// EventReasonSyncServiceSucceed is indicates that sync service work succeed.
	EventReasonSyncServiceSucceed string = "SyncServiceWorkSucceed"
